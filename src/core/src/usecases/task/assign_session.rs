...
#[async_trait]
impl<R: TaskRepository + Send + Sync> UseCase<AssignSessionInput, Task> for AssignSessionUseCase<R> {
...
mod tests {
    ...
    async fn create_test_repos() -> (CreateTaskUseCase<SqliteTaskRepository>, AssignSessionUseCase<SqliteTaskRepository>) {
        ...
        (CreateTaskUseCase::new(repo1), AssignSessionUseCase::new(repo2))
    }
    ...
    async fn test_assign_session() {
        ...
        assert_eq!(assigned_task.assigned_session, Some("session_123".to_string()));
